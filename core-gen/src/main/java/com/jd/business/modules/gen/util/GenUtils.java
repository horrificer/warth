package com.jd.business.modules.gen.util;

import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import com.jd.business.modules.gen.entity.*;
import common.config.Global;
import common.mapper.JaxbMapper;
import common.utils.DateUtils;
import common.utils.FileUtils;
import common.utils.FreeMarkers;
...
public class GenUtils {
    ...
    public static Map<String, Object> getDataModel(GenScheme genScheme) {
        ...
        model.put("functionAuthor", StringUtils.isNotBlank(genScheme.getFunctionAuthor()) ? genScheme.getFunctionAuthor() : "wanghong12");
